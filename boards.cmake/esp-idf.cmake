...
if (IDF_VERSION_MAJOR GREATER_EQUAL 5)
    if(IDF_VERSION_MINOR GREATER_EQUAL 1)
        set(COMPONENT_REQUIRES nvs_flash efuse esp_lcd esp_timer esp_mm driver esp_driver_gpio esp_driver_i2c esp_driver_spi esp_driver_ledc esp_driver_parlio esp_driver_i2s)
        if (EXISTS "$ENV{IDF_PATH}/components/esp_driver_gdma")
            list(APPEND COMPONENT_REQUIRES esp_driver_gdma)
        elseif (EXISTS "$ENV{IDF_PATH}/components/esp_driver_dma")
            list(APPEND COMPONENT_REQUIRES esp_driver_dma)
        endif()
    else()
        set(COMPONENT_REQUIRES nvs_flash efuse esp_lcd esp_timer driver esp_driver_gpio esp_driver_i2c esp_driver_spi esp_driver_ledc esp_driver_i2s)
    endif()
